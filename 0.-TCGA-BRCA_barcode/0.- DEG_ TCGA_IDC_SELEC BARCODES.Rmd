...
Here is a brief overview on analysis steps:
  ...
  * - 0.1.- Work environment preparation
  * - 0.2.- Download data
  * - 0.3.- Data group seletion
...
#setwd("./Scrips_R/0.-TCGA-BRCA_barcode")
...
BRCA_Rnaseq_STAR_TM <- GDCprepare(query_STAR_TM, save = T, save.filename = "0.- query_STAR_TM.rda")
BRCA_Rnaseq_STAR_TP <- GDCprepare(query_STAR_TP, save = T, save.filename = "0.- query_STAR_TP.rda")

load("0.- query_STAR_TM.rda")
BRCA_Rnaseq_STAR_TM <- data

load("0.- query_STAR_TP.rda")
...
# 0.3.-  Data Grup selection

      * - 0.3.1- Metastatic Samples (TM)
...
saveRDS(object = BRCA_TP_filtered,
        file = "0.- BRCA_TP_filtered.rda",
        compress = FALSE)
load( file = "0.- BRCA_TP_filtered.rda")
